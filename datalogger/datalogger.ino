...
#define MEAN_SIZE 200 // Tamanho do vetor de aquisições
#define SERIAL_NUMBER "XXXXXXXX" // Numero de série
#define SAMPLE_TIME 300 // Tempo de amostragem para o PID
...
void loop() {
  ...
  Temps = mean_temp(((1.1*analogRead(35)/4095*3.5481)-0.5)*100); // Leitura da temperatura
